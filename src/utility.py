...
#create logger
def new_logger():
    logger=logging.getLogger("Supermarket Personalized Advertisement Generator App Started! \n Logger activated!")
    logger.setLevel(logging.INFO)
    #create the logfile
    logfile = logging.FileHandler(".\supermarket.log")
    ...
    def log_wrapper(*args, **kwargs):
        ...
        try:
           ...
           #log the exception
            ...
            #log the exception
            error=f"OSError exception occurred in: '{func.__name__}' "
            print(error)
            logger.exception(error)
